...
![image-20220221183712808](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220221183712808.png)
...
![image-20220224203935387](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220224203935387.png)
...
![image-20220224204652831](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220224204652831.png)
...
![image-20220226144734017](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226144734017.png)



goods 商品表

![image-20220226144811722](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226144811722.png)

goods 表数据

![image-20220226144838522](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226144838522.png)
...
2. 注册监听器 ContextLoaderListener
   ...
   ![image-20220226184121788](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226184121788.png)

   所以，在这四个方法中较重要的方法应该就是 contextInitialized()，context 初始化方法。

   跟踪 initWebApplicationContext()方法，可以看到，在其中创建了容器对象。

   ![image-20220226184301555](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226184301555.png)

   并且，将创建好的容器对象放入到了 ServletContext 的空间中，key 为一个常量： WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE。

   ![image-20220226184340466](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226184340466.png)
...
3. 指定 Spring 配置文件的位置 spring-param
   ...
   ![image-20220226184620651](X:\Markdown笔记\Java生态\03-框架\04-Spring.assets\image-20220226184620651.png)
